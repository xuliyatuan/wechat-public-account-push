...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: 'ZqbwD_0_xKk4EQTbx9YUK8cyuih6D-spZrArgSskQDk',
      ...
      festivals: [
        ...
        {
          birthday: '生日', name: '崽崽', year: '1999', date: '07-27',
        },
        {
  ...
  CALLBACK_TEMPLATE_ID: 'ZqbwD_0_xKk4EQTbx9YUK8cyuih6D-spZrArgSskQDk',
